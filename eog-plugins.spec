...
Source0  : https://download.gnome.org/sources/eog-plugins/3.26/eog-plugins-3.26.7.tar.xz
...
%prep
%setup -q -n eog-plugins-3.26.7
cd %{_builddir}/eog-plugins-3.26.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619118582
...
cp %{_builddir}/eog-plugins-3.26.7/COPYING %{buildroot}/usr/share/package-licenses/eog-plugins/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
%make_install
