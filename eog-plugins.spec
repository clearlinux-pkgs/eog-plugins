...
Version  : 3.26.4
Release  : 17
URL      : https://download.gnome.org/sources/eog-plugins/3.26/eog-plugins-3.26.4.tar.xz
Source0  : https://download.gnome.org/sources/eog-plugins/3.26/eog-plugins-3.26.4.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568072540
