...
Source0  : https://download.gnome.org/sources/eog-plugins/42/eog-plugins-42.0.tar.xz
...
%prep
%setup -q -n eog-plugins-42.0
cd %{_builddir}/eog-plugins-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647872041
...
cp %{_builddir}/eog-plugins-42.0/COPYING %{buildroot}/usr/share/package-licenses/eog-plugins/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
